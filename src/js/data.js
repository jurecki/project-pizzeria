...
dataSource.products = {
  cake: {
    ...
    price: 9,
    description: 'TEST Treat yourself with this soft, freshly baked cookie. The recipe has been handed down from generation to generation in our family and it has won us several first place prizes in local competitions.',
    images: [
